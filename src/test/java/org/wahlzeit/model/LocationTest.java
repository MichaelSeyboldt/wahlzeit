...
public class LocationTest {
    ...
    public void distances(){
        assertEquals(zero.getDistance(zero),0., 0.0000001);
        assertEquals(zero.getDistance(tenx), 10.,0.000001);
        assertEquals(zero.getDistance(teny),10. , 0.00001);
        assertEquals(zero.getDistance(tenz),10., 0.000001);
